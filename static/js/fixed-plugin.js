var pageName = page;
var sidenav_target = to_build + "templates/" + pageName + ".html";
...
function sidebarColor(a) {
  ...
  var checkedSidenavCardColor =
    "after:bg-gradient-" + (color == "fuchsia" ? "slate" : color);
  var checkedSidenavCardIconColorClass =
    "bg-gradient-" + (color == "fuchsia" ? "slate" : color);
  ...
  for (var i = 0; i < parent.length; i++) {
    if (parent[i].hasAttribute("active-color")) {
      ...
      activeSidenavCardColorClass =
        "after:bg-gradient-" +
        (activeColor == "fuchsia" ? "slate" : activeColor);
      activeSidenavCardIconColorClass =
        "bg-gradient-" + (activeColor == "fuchsia" ? "slate" : activeColor);
    }
